...
export interface ExperienceSliceDefaultPrimaryExperienceDetailsItem {
  ...
  /**
   * Institution field in *Experience → Default → Primary → Experience Details*
   *
   * - **Field Type**: Text
   * - **Placeholder**: *None*
   * - **API ID Path**: experience.default.primary.experience_details[].institution
   * - **Documentation**: https://prismic.io/docs/field#key-text
   */
...
/**
 * Item in *TechList → Default → Primary → Tech Details*
 */
export interface TechListSliceDefaultPrimaryTechDetailsItem {
  /**
   * Tech Name field in *TechList → Default → Primary → Tech Details*
   *
   * - **Field Type**: Text
   * - **Placeholder**: *None*
   * - **API ID Path**: tech_list.default.primary.tech_details[].tech_name
   * - **Documentation**: https://prismic.io/docs/field#key-text
   */
  tech_name: prismic.KeyTextField;

  /**
   * Tech Color field in *TechList → Default → Primary → Tech Details*
   *
   * - **Field Type**: Color
   * - **Placeholder**: *None*
   * - **API ID Path**: tech_list.default.primary.tech_details[].tech_color
...
export interface TechListSliceDefaultPrimary {
  ...
  /**
   * Tech Details field in *TechList → Default → Primary*
   *
   * - **Field Type**: Group
   * - **Placeholder**: *None*
   * - **API ID Path**: tech_list.default.primary.tech_details[]
   * - **Documentation**: https://prismic.io/docs/field#group
   */
  tech_details: prismic.GroupField<
    Simplify<TechListSliceDefaultPrimaryTechDetailsItem>
  >;
}
...
declare module "@prismicio/client" {
  ...
  namespace Content {
    export type {
      ...
      TechListSlice,
      TechListSliceDefaultPrimaryTechDetailsItem,
